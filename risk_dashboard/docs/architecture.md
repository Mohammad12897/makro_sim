...
### 2. Ingestion
- CSVs und API‑Daten werden transformiert und in `data/processed/` abgelegt.

### 3. Feature Engineering
- `src/features/fx_features.py` erzeugt FX‑ und Makrofeatures.
- Missing Values werden imputiert, Zeitreihen resampled und synchronisiert.
...
## 3.1 Datenflussdiagramme (Textform)
